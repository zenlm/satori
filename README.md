...
- [text-to-image model](https://github.com/zenlm/flux): A powerful text-to-image generation model.
- [Latte](https://github.com/Vchitect/Latte): An attempt to efficiently train DiT for video.
- [baseline](https://github.com/zenlm/baseline/tree/main?tab=readme-ov-file): Open-Source text-to-video model.
...
- [LLaVA](https://github.com/haotian-liu/LLaVA): A powerful image captioning model based on [Zen 7B](https://huggingface.co/zenlm/Zen 7B-v0.1) and [Yi-34B](https://huggingface.co/01-ai/Yi-34B).
